...
def create():
    ...
    channels |= Channel("L6-2_qd", port=controller.ports(3))  # drive    dac3
    ...
    channels |= Channel("L6-3_qd", port=controller.ports(4))  # drive    dac4
    channels |= Channel("L6-41_fl", port=controller.ports(1))  # flux     dac2
    # QUBIT 4
    channels |= Channel("L1-1-RO_0", port=controller.ports(3))  # feedback adc0
    channels |= Channel("L6-4_qd", port=controller.ports(5))  # drive    dac5
    channels |= Channel("L6-42_fl", port=controller.ports(2))  # flux     dac2
