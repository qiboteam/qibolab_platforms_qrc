...
from qibolab._core.instruments.qblox_scheduler.cluster import QBSchedulerController
...
def create():
    ...
    controller = QBSchedulerController(name=NAME, address=ADDRESS, channels=channels)
