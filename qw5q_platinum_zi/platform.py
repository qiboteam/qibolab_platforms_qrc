...
def create():
    ...
    qubits[4].drive.power_range = 10

    qubits[0].flux.power_range = 4
    qubits[1].flux.power_range = 4
    qubits[2].flux.power_range = 4
    qubits[3].flux.power_range = 4
